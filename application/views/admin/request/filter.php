<div class="entries-sort <?=!empty($_GET) ? 'open' : null;?>">
    ...
    <form action="<?=base_url('admin/'.$this->page)?>" method="GET" class="entries-sort-content">
        <div class="entries-sort-row row">
            ...
            <div class="col-md-6 col-lg-3">
                <? $sorts = [
                    'typework DESC' => 'Тип работы &darr;',
                    'typework ASC' => 'Тип работы &uarr;',
                    'timesvjazi DESC' => 'Свежие &darr;',
                    'timesvjazi ASC' => 'Старые &uarr;',
                    'adres ASC' => 'Адрес &uarr;',
                    'adres DESC' => 'Адрес &darr;',
