		...
		<?=form_open('', ['class' => 'login-form']);?>
			...
			<div class="actions">
				<div class="actions-left">
					<button class="btn btn-lg btn-info"><?=fa5s('sign-in-alt mr5');?> Войти</button>
				</div>
				<div class="actions-right">
					<?=anchor('/admin/login/recovery', fa5r('question-circle color-error').'<span>Забыли пароль?</span>', array('class' => 'actions-link'));?>
				</div>
			</div>
		<?=form_close();?>
	</div>
