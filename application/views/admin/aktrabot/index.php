        ...
        <? foreach($items as $item) { ?>
            <tr data-entries="item">
                <td class="entries-table-mobile">
                    <div class="entries-title" data-entries="title"><?=$item['equipment'];?></div>
                    <div class="entries-brief"><?=$item['factory_number'];?></div>
                </td>
                <td class="entries-td-hide-sm" nowrap>
                    <?=entries_date($item['type']);?>
                </td>
                <td class="entries-td-hide-sm" nowrap>
                    <?=entries_date($item['status']);?>
                </td>
                <td class="entries-td-icons entries-td-hide-xs text-right">
                    <?=visibility($item['completed_works']);?>
                </td>
