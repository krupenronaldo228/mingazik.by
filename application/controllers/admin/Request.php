...
class Request extends ADMIN_Controller
{
    ...
    public function create()
    {
        ...
        if ($_POST) {
            try {
                ...
                set_flash('result', action_result('success', fa5s('check mr5') . ' Заявка на <strong>"' . $insert['adres'] . '"</strong> успешно добавлена!', true));
    ...
    public function delete()
    {
        ...
        if ($error) {
            ...
            set_flash('result', action_result('success', fa5r('trash-alt mr5') . ' Заявка на <strong>"' . $item['adres'] . '"</strong> успешно удалена!', true));
        }
